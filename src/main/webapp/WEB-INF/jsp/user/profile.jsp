...
<div id="app">
    <div class="main-wrapper">
        ...
        <div class="main-content">
            <div class="mt-4 mb-4 p-3 hide-sidebar-mini" style="margin : 0px">

                <a href="/addAuto" class="btn btn-primary btn-lg btn-block btn-icon-split">
                    <i class="fas fa-rocket"></i> Elan Yerəşdir
                </a>
            </div>
