...
public class User extends AutoBazarBase implements Serializable {
    ...
    public User(long id, String name, String surname, String email, String mobile1) {
        this.id = id;
        this.name = name;
    ...
    public User(String name, String surname, String email, String password, String mobile1, String mobile2, UserStatus userStatus, List<Role> roleList, LocalDateTime registrationDate, LocalDateTime activationDate) {
        this.name = name;
        this.surname = surname;
        this.email = email;
